    ...
    >
      ...
      >
        <div className="flex gap-x-2">
          ...
          <a
            href="mailto:info@devbhoomielevator.com"
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex gap-x-2 items-center">
            <Link
              to="#"
              className="bg-blue-400 p-2 rounded-full hover:bg-white hover:text-blue-400"
            >
              <FaFacebookF />
            </Link>
            <Link
      ...
      <section className="flex flex-col items-center justify-center text-center py-32 bg-cover bg-center min-h-[500px]">
        ...
        >
          ...
          <p className="text-lg mt-4 max-w-3xl">
            With the experience of 9 Years from 2015 at Uttarakhand, Himachal
            Pradesh, and all over the Tricity Punjab (India), we believe Heaven
            is a real place...!
          </p>
        </motion.div>
